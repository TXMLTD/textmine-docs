...
Custom tags let a team ask repeatable questions over documents and persist the answers.

Supported patterns include:

- Fact-style questions over document text.
- Deep RAG-style questions for broader retrieval and reasoning.
- Chained tags that use other tags, entities, or tables as context.
