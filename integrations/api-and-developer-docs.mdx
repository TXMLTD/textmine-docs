...
TextMine product documentation lives at this site. API reference, ReadMe MCP, exact schemas, operation IDs, and client setup guides live at [developers.textmine.com](https://developers.textmine.com). Service-account provisioning for autonomous agents starts with [agent self-service signup](/integrations/third-party-agent-signup), which returns an encrypted `tm_...` API key for the trusted runtime to decrypt and store.
