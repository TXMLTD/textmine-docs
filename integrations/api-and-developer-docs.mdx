...
| Signup discovery | `/v3/third-party-agents/signup/discovery` |
...
2. Fetch `/.well-known/textmine-agent.json` or `/v3/third-party-agents/signup/discovery`.
3. Check `/v3/third-party-agents/signup/availability`.
4. Generate a runtime RSA keypair and submit the public key with `POST /v3/third-party-agents/signup/self-service`.
