...
For the UK multitenant deployment, enter `https://public-api.textmine.com` as the Public API Base URL. Do not enter `https://app.textmine.com` or the internal API host.
