...
Use [Zapier](/integrations/zapier) when a Zap should automate TextMine work through Public API V3. Zapier uses a TextMine-issued service account API key and the Public API base URL shown in TextMine Settings.
