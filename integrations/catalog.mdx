...
TextMine integrations fall into several shapes: OAuth-connected providers, Vault-level native integrations, workflow integrations, the TextMine MCP server, and Workbench MCP/provider imports.
