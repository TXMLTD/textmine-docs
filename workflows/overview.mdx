...
description: "Learn how TextMine workflows automate document and data processes with triggers, conditions, approvals, integrations, reports, and run history."
---
...
![TextMine workflow builder showing automation steps for document and data processes](/images/intercom/product-updates/26-may-2026/03-screenshot-2026-05-26-at-14-19-19.png)
...
Workflow actions can run agents, upload to Vault, use Workbench-uploaded files, extract text, search EDGAR or fetch SEC filings, wait for document processing, apply playbooks, set or calculate values, reconcile data, compare against accepted outputs, enrich values, call APIs or webhooks, export Tableau or Power BI outputs, lookup or create records, collect analytics, sample populations, extract tables or line items, run AI reviews, fill templates, send reports, add reviewers or assignees, create alerts, request approvals, send to Legislate, import or submit to integrations, and send email.
